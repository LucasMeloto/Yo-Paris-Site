                                    ...
                                    <form action="acoes.php" method="post">
                                        <div class="form-row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="categoria" id="categoria" class="form-control" require value="<?php echo $categoria['nome_categoria'] ?>">
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <textarea name="observacao" id="observacao" class="form-control mb-3"><?php echo $categoria['observacao']?></textarea>

                                        <input type="hidden" name="atualizar" value="atualizar_categoria">
                                        <input type="hidden" name="cod_categoria" value="<?php echo $codigo ?>">
