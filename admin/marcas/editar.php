        ...
        <div class="row">
            ...
            <main class="ml-auto col-lg-10 px-md-4">
                <div class="container mt-5">
                    ...
                    <?php
                    if (isset($_GET['cod_marca']) && $_GET['cod_marca'] != '') {
                        ...
                        $codigo = $_GET['cod_marca'];

                        $sql = "SELECT * FROM marca WHERE cod_marca = $codigo";
                            ...
                            <form action="acoes.php" method="post">
                                <div class="form-row mb-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="marca" id="marca" class="form-control" require value="<?php echo $marca['nome_marca'] ?>">
                                    </div>
                                    <div class="col-6">
                                ...
                                <textarea name="observacao" id="observacao" class="form-control mb-3"><?php echo $marca['observacao'] ?></textarea>

                                <input type="hidden" name="atualizar" value="atualizar_marca">
                                <input type="hidden" name="cod_marca" value="<?php echo $codigo ?>">
